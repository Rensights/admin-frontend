...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Early Access", path: "/early-access", pro: false },
      { name: "Customer Analytics", path: "/customer-analytics", pro: false },
    ],
  },
  {
    icon: <ListIcon />,
...
const AppSidebar: React.FC = () => {
  ...
  const isActive = useCallback((path: string) => {
    ...
    return pathWithoutQuery === currentPathWithoutQuery || path === pathname;
  }, [pathname]);
      ...
      >
        <Link href="/" className="flex items-center gap-2">
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            <span className="text-2xl font-bold text-brand-500">R</span>
          )}
        </Link>
      </div>
